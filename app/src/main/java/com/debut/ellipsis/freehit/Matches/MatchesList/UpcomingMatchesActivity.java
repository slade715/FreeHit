...
public class UpcomingMatchesActivity extends AppCompatActivity {
    ...
    void UpcomingMatchesList() {
        Call<UpcomingMatchCardItem> call = MainActivity.apiInterface.doGetUpcomingCompleteMatchListResources(key);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (UpcomingMatchListAdapter.getFilter() == null) {
                    ...
                    UpcomingMatchListAdapter.getFilter().filter(query);
