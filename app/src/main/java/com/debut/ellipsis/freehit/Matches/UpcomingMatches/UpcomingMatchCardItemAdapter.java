...
public class UpcomingMatchCardItemAdapter extends RecyclerView.Adapter<UpcomingMatchCardItemAdapter.ViewHolder> {
    ...
    public UpcomingMatchCardItemAdapter(Context context, List<UpcomingMatchCardItem> UpcomingMatchCards) {
    ...
    @Override
    public UpcomingMatchCardItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new UpcomingMatchCardItemAdapter.ViewHolder(contactView);
    }

    // Involves populating data into the item through holder
    @Override
    public void onBindViewHolder(UpcomingMatchCardItemAdapter.ViewHolder viewHolder, int position) {
